# ============================================================
# VARIANT: v7_g1
# CHANGE:  Good-value cutoff 0.55 -> 0.50 (loosen value-bet boundary)
# HYPOTHESIS: v7's value-bet boundary is too tight under deflated range-equity; loosening recaptures thin value. Should help broadly; risk small overpay against tight opponents.
# DIFF FROM v7: single-line cutoff change in _postflop_by_equity
#   (if eq >= 0.55:  ->  if eq >= 0.50:)
