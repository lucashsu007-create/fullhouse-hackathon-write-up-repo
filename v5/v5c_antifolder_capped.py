...
_AF_BLUFF_SIZE = 0.5               # SMALL c-bet/steal size (pot fraction)
_AF_FREQ_CAP = 0.65               # max share of qualifying spots we actually bluff
_AF_SAFETY_MARGIN = 0.12           # observed fold rate must beat break-even by this
