...
BOT_NAME = "v16_squeeze_B_tight_AA_KK_QQ"
BOT_AVATAR = "robot_1"
...
_V16_SQUEEZE_HANDS = {"AA", "KK", "QQ"}  # AA/KK/QQ only, no tiny sizing tweak
...
def _v16_premium_squeeze_action(state, hand, history, facing_jam):
    ...
    target = max(int(opener_to * (4.2 + callers)), opener_to + int(0.9 * pot))
