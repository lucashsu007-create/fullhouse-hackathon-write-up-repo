...
DEF_FOLD_VS_VALUE   = True     # fold marginal hands vs confirmed value-heavy / traps
DEF_CALL_VS_BLUFF   = False     # call marginal folds vs confirmed over-bluffers
