...
FIX_SIZING   = True   # #1  one bet size across the value range (kill the tell)
FIX_TRAP     = True   # #2  sometimes CHECK strong hands so checks aren't capped
FIX_RIVER    = True   # #3  bigger value sizing on the river (value half only)
FIX_MULTIWAY = True   # #5  tighten value/bet thresholds with more opponents
