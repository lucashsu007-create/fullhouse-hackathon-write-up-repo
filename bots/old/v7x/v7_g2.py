# ============================================================
# VARIANT: v7_g2
# CHANGE:  Good-value cutoff 0.55 -> 0.60 (tighten value-bet boundary)
# HYPOTHESIS: v7's old 0.55 threshold under range-equity is now too loose for what it represents; tightening reduces marginal bluff-catch losses. Should help vs aggro/trap; risk vs passive.
# DIFF FROM v7: single-line cutoff change in _postflop_by_equity
#   (if eq >= 0.55:  ->  if eq >= 0.60:)
