# ============================================================
# VARIANT: v10-sqz-t (built on v7_m2)
# SQUEEZER-DEFENSE LEAK FIX: only _VS_3BET is changed.
# CHANGES: Small fix: add 77, A8s/A9s, KTs, KJo, ATo; bump 88/99.
...
# v7_m2_sqz_t: small fix — add 77, A8s/A9s, KTs, KJo, ATo; bump 88/99 freqs.
_VS_3BET = {
    # Pairs (88/99 bumped, 77 added)
    "AA": _d(1.0), "KK": _d(0.95, 0.05),
    "QQ": _d(0.50, 0.50), "JJ": _d(0, 0.85), "TT": _d(0, 0.65),
    "99": _d(0, 0.65), "88": _d(0, 0.50), "77": _d(0, 0.45),
    # Aces (A8s/A9s/ATo added)
