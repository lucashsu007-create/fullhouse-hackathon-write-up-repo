# ============================================================
# VARIANT: v7_m1
# CHANGE:  Marginal cutoff 0.38 -> 0.34 (loosen marginal-call threshold)
# HYPOTHESIS: v7 folds too many marginal showdowns; loosening calls more. Helps vs bluffy/aggressive; risks vs nitty.
# DIFF FROM v7: single-line cutoff change in _postflop_by_equity
#   (if eq >= 0.38:  ->  if eq >= 0.34:)
