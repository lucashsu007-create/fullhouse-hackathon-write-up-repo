# ============================================================
# VARIANT: v10-sqz-4b (built on v7_m2)
# SQUEEZER-DEFENSE LEAK FIX: only _VS_3BET is changed.
# CHANGES: 4-bet bluffs: V2 calls + bumped A5s/A4s, new A3s/A2s/K5s/K4s/K3s 4bet bluffs.
...
# v7_m2_sqz_4b: 4-bet bluff variant — V2's calling range plus a heavier 4-bet
# bluff range (bumped A5s/A4s, new A3s/A2s, new K-blocker bluffs K5s/K4s/K3s).
_VS_3BET = {
    # Pairs (same as V2 = sqz_m)
    "AA": _d(1.0), "KK": _d(0.95, 0.05),
    "QQ": _d(0.50, 0.50), "JJ": _d(0, 0.85), "TT": _d(0, 0.65),
    "99": _d(0, 0.65), "88": _d(0, 0.50), "77": _d(0, 0.45),
    "66": _d(0, 0.30), "55": _d(0, 0.25), "44": _d(0, 0.20),
    "33": _d(0, 0.15), "22": _d(0, 0.15),
    # Aces (same as V2)
    "AKs": _d(0.85, 0.15), "AKo": _d(0.50, 0.50),
    "AQs": _d(0, 0.85), "AQo": _d(0, 0.30),
    "AJs": _d(0, 0.55), "ATs": _d(0, 0.30), "ATo": _d(0, 0.25),
    "A9s": _d(0, 0.40), "A8s": _d(0, 0.30),
    "A7s": _d(0, 0.25), "A6s": _d(0, 0.20),
    # Kings (same as V2)
    "KQs": _d(0, 0.50), "KJs": _d(0, 0.20), "KTs": _d(0, 0.35),
    "K9s": _d(0, 0.25),
    "KJo": _d(0, 0.30), "KTo": _d(0, 0.20),
    # Queens (same as V2)
    "QJs": _d(0, 0.20), "QTs": _d(0, 0.30), "QJo": _d(0, 0.25),
    # Suited connectors (same as V2)
    "JTs": _d(0, 0.20), "T9s": _d(0, 0.30), "98s": _d(0, 0.25), "87s": _d(0, 0.20),
    # 4-bet bluffs — the distinguishing change from V2:
    # bumped A5s/A4s, new A3s/A2s Ace-blockers, new K5s/K4s/K3s King-blockers
    "A5s": _d(0.30), "A4s": _d(0.25),
    "A3s": _d(0.25), "A2s": _d(0.20),
    "K5s": _d(0.15), "K4s": _d(0.10), "K3s": _d(0.08),
}
