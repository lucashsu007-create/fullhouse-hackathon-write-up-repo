...
BOT_NAME = "v16_squeeze_A_ultratight_AA_KK"
BOT_AVATAR = "robot_1"
...
_V16_SQUEEZE_HANDS = {"AA", "KK"}  # AA/KK only, no tiny sizing tweak
...
def _v16_premium_squeeze_action(state, hand, history, facing_jam):
    ...
    target = max(int(opener_to * (4.5 + callers)), opener_to + int(0.9 * pot))
