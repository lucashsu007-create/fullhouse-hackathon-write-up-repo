# ============================================================
# VARIANT: v10-sqz-m (built on v7_m2)
# SQUEEZER-DEFENSE LEAK FIX: only _VS_3BET is changed.
# CHANGES: Medium fix: + 22-66 set-mining, A6s-A7s, K9s/KTo, QTs, T9s/98s/87s.
...
# v7_m2_sqz_m: medium fix — V1 plus small pairs (22-66) for set-mining,
# more suited Aces/Kings, QTs, and suited connectors T9s/98s/87s.
_VS_3BET = {
    # Pairs
